...
CUDA_VISIBLE_DEVICES=2 python -m llava.eval.model_vqa_lora \
    ...
    --conv-mode vicuna_v1 &
sleep 60
#CUDA_VISIBLE_DEVICES=3 python -m llava.eval.model_vqa_lora \
    #--model-path /mnt/private_yucheng/chartgpt/LLaVA/checkpoints/${output_name} \
    ...
    #--conv-mode vicuna_v1 &
#sleep 60
CUDA_VISIBLE_DEVICES=4 python -m llava.eval.model_vqa_lora \
    --model-path /mnt/private_yucheng/chartgpt/LLaVA/checkpoints/${output_name} \
    ...
    --conv-mode vicuna_v1 &
sleep 60
CUDA_VISIBLE_DEVICES=5 python -m llava.eval.model_vqa_lora \
    --model-path /mnt/private_yucheng/chartgpt/LLaVA/checkpoints/${output_name} \
    ...
    --conv-mode vicuna_v1 &
sleep 60
CUDA_VISIBLE_DEVICES=6 python -m llava.eval.model_vqa_lora \
    --model-path /mnt/private_yucheng/chartgpt/LLaVA/checkpoints/${output_name} \
    ...
    --conv-mode vicuna_v1 &
sleep 60
CUDA_VISIBLE_DEVICES=7 python -m llava.eval.model_vqa_lora \
    --model-path /mnt/private_yucheng/chartgpt/LLaVA/checkpoints/${output_name} \
