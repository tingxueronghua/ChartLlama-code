...
deepspeed llava/train/train.py \
    ...
    --version v1 \
    --data_path /mnt/share_1227775/yandali/multimodal/data/llava-finetune/llava_v1_5_mix665k_v2.json \
    --image_folder /mnt/share_1227775/yandali/multimodal/data/llava-finetune \
    ...
    --fp16 True \
    --lora_r 64 \
    --output_dir ./checkpoints/llava-v1.5-from-pretrained-finetune_lora \
    --num_train_epochs 1 \
